...
from common_utils.init_env import LLM_KEY, LLM_MODEL, LLM_URL, LLM_TEMPERATURE, LLM_MAX_TOKEN, LLM_CHUNK_SIZE, LLM_CHUNK_OVERLAP

class ConfigMeasuresLLM(ConfigLLM):
